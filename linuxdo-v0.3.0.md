...
[上一版](https://linux.do/t/topic/1745762)发了 InkOS，5 个 Agent 接力完成写→审→改全流程，跑了一本玄幻 31 章 45 万字。跑完发现一个问题：所有创作规则都硬编码在 agent 里，写玄幻没问题，换个题材就全乱了——都市文出现"同质吞噬衰减公式"，恐怖文要求"三章内必须打脸"。
